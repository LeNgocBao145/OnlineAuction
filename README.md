...
* Hệ thống kiểm tra điểm đánh giá (+/-) hơn 80% thì mới cho phép ra giá.
    * *Ví dụ:* Bidder được đánh giá 10 lần, có 8+ và 2-, vậy điểm của bidder này là $8/10 \sim 80\%$, được phép tham gia đấu giá sản phẩm.
...
* Nhập đủ thông tin:
    ...
    * Bước giá
    * Giá mua ngay (nếu có)
    * Mô tả sản phẩm: Hỗ trợ WYSIWYG (quilljs, TinyMCE...)
...
> *Ví dụ minh họa hiển thị:*
>
> **31/10/2025**
>
> 電源入り撮影出来ましたが細部の機能までは確認していません。
> 不得意ジャンルの買い取り品の為細かい確認出来る知識がありません、ご了承ください。
> 簡単な確認方法が有れば確認しますので方法等質問欄からお願いします、終了日の質問には答えられない土
> 付属品、状態は画像でご確認ください。
> 当方詳しくありませんので高度な質問には答えられない場合がありますがご了承ください。
> 発送は佐川急便元払いを予定しています、破損防止の為梱包サイズが大きくなる事がありますがご了承下
> 中古品の為NC/NRでお願いします。
>
> **5/11/2025**
>
...
### 3.5 Quản lý hồ sơ cá nhân (tiếp theo)
...
### 5.1 Đăng nhập
* Tự cài đặt hoặc sử dụng passportjs.
...
* **Người mua đặt câu hỏi:**
    * Gửi người bán
* **Người bán trả lời:**
    * Gửi các người mua tham gia đấu giá & các người mua có đặt câu hỏi.
...
**Ví dụ thông tin sản phẩm đấu giá:**
* iPhone 11
* Giá khởi điểm: 10tr
* Bước giá: bội 100k

**Bảng mô phỏng Đấu giá thông thường:**
...
*Ghi chú: Bidder cần thao tác liên tục để đưa giá mới vào sản phẩm.*
...
Hệ thống chỉ cài đặt đấu giá tự động hoặc đấu giá thường, không cài cả 2.
